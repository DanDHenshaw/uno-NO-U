...
bot.on('message', async message => {
  ...
  if(message.content.toLowerCase() === "no u" || message.content.toLowerCase() === "no you")
    message.reply("**No U**");
